...
if length(fig_subj_names)/2 ~= length(unique(T.SN))
...
fig_ref_lines = [5.5 10.5 20.5 70.5 160.5 165.5 195.5 235.5 265.5 305.5 310.5 340.5 380.5 385.5 415.5 420.5 470.5];
...
for i = 1 % subj to plot
    ...
    drawline1(fig_ref_lines, 'dir', 'vert', 'linestyle', ':');  % Draws line for blocks
